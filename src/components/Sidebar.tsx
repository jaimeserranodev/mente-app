      ...
      >
        <div className="flex justify-between text-center">
          <div>
            ...
            <p className="text-[10px] leading-tight mt-0.5" style={{ color: '#8C8C7A' }}>
              Total
            </p>
          </div>
          <div
